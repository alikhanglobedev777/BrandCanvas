...
export const INVENTORY_ADJUSTMENT_TYPES = ["manual_increase", "manual_decrease"] as const;
export type InventoryAdjustmentTypeValue = (typeof INVENTORY_ADJUSTMENT_TYPES)[number];
